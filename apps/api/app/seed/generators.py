...
DEVICE_CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "indication": "EVAR",
        "ifu_proximal_min_mm": 19.0,
        "ifu_proximal_max_mm": 36.0,
        "ifu_distal_min_mm": 7.5,
        "ifu_distal_max_mm": 22.0,
        "ifu_length_options_mm": [80, 100, 120, 140, 160],
    ...
    },
    {
        ...
        "indication": "TEVAR",
        "ifu_proximal_min_mm": 20.0,
        "ifu_proximal_max_mm": 42.0,
        "ifu_distal_min_mm": 16.0,
        "ifu_distal_max_mm": 40.0,
        "ifu_length_options_mm": [100, 150, 200],
        "ifu_min_neck_length_mm": 20.0,
        "ifu_max_neck_angulation_deg": 40.0,
        "ifu_iliac_min_mm": 7.5,
        "ifu_iliac_max_mm": 28.0,
        "sheath_fr": 22,
        "contraindications": [
            "Aortic diameter < 20 mm or > 42 mm at intended landing",
            "< 20 mm healthy aorta proximal to aneurysm",
        ],
        "deployment_steps": [
    ...
    },
    {
        ...
        "indication": "TEVAR",
        "ifu_proximal_min_mm": 22.0,
        "ifu_proximal_max_mm": 40.0,
        "ifu_distal_min_mm": 14.0,
        "ifu_distal_max_mm": 36.0,
        "ifu_length_options_mm": [100, 150, 200, 250],
        "ifu_min_neck_length_mm": 20.0,
        "ifu_max_neck_angulation_deg": 45.0,
        "ifu_iliac_min_mm": 8.0,
        "ifu_iliac_max_mm": 28.0,
        "sheath_fr": 22,
    ...
    },
    {
        ...
        "indication": "EVAR",
        "ifu_proximal_min_mm": 16.0,
        "ifu_proximal_max_mm": 30.0,
        "ifu_distal_min_mm": 7.0,
        "ifu_distal_max_mm": 20.0,
        "ifu_length_options_mm": [80, 100, 120, 140],
        "ifu_min_neck_length_mm": 10.0,
        "ifu_max_neck_angulation_deg": 75.0,
        "ifu_iliac_min_mm": 5.5,
        "ifu_iliac_max_mm": 20.0,
        "sheath_fr": 14,
    ...
    },
    {
        ...
        "indication": "TEVAR",
        "ifu_proximal_min_mm": 26.0,
        "ifu_proximal_max_mm": 46.0,
        "ifu_distal_min_mm": 20.0,
        "ifu_distal_max_mm": 42.0,
        "ifu_length_options_mm": [150, 200],
        "ifu_min_neck_length_mm": 25.0,
        "ifu_max_neck_angulation_deg": 30.0,
        "ifu_iliac_min_mm": 9.0,
        "ifu_iliac_max_mm": 30.0,
        "sheath_fr": 24,
    ...
    },
    {
        ...
        "ifu_iliac_min_mm": 6.5,
        "ifu_iliac_max_mm": 24.0,
        "sheath_fr": 18,
    ...
    },
    {
        ...
        "indication": "TEVAR",
        "ifu_proximal_min_mm": 24.0,
        "ifu_proximal_max_mm": 44.0,
        "ifu_distal_min_mm": 20.0,
        "ifu_distal_max_mm": 40.0,
        "ifu_length_options_mm": [100, 150, 200, 250],
        "ifu_min_neck_length_mm": 20.0,
    ...
    },
    {
        ...
        "ifu_proximal_max_mm": 36.0,
        "ifu_distal_min_mm": 16.0,
        "ifu_distal_max_mm": 34.0,
        "ifu_length_options_mm": [100, 150, 200],
        "ifu_min_neck_length_mm": 20.0,
        "ifu_max_neck_angulation_deg": 45.0,
        "ifu_iliac_min_mm": 7.5,
        "ifu_iliac_max_mm": 26.0,
        "sheath_fr": 20,
        "contraindications": [],
        "deployment_steps": [
...
def generate_patients(n: int = 200) -> list[dict[str, Any]]:
    ...
    for i in range(1, n + 1):
        ...
        patient = {
            ...
            "surgery_date": (datetime.now(UTC) - timedelta(days=rng.randint(1, 60))).date()
            if phase != "pre"
            else None,
            **anatomy,
