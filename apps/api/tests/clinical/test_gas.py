...
def test_young_healthy_patient():
    ...
    result = compute_gas(GASInputs(age=60, shock=False, myocardial_disease=False,
...
def test_elderly_with_comorbidities():
    ...
    result = compute_gas(GASInputs(age=75, shock=False, myocardial_disease=True,
                                   cerebrovascular_disease=False, renal_disease=True))
...
def test_all_factors_present():
    ...
    result = compute_gas(GASInputs(age=80, shock=True, myocardial_disease=True,
